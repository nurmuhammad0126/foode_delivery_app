...
class MealRatingScreen extends StatefulWidget {
  const MealRatingScreen({super.key});

  @override
  State<MealRatingScreen> createState() => _MealRatingScreenState();
}

class _MealRatingScreenState extends State<MealRatingScreen> {
  @override
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    WScaleAnimation(
                      onTap: () {
                        context.pushNamed(AppRoutesNames.restaurant);
                      },
